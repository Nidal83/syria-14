...
export const en: Translations = {
  ...
  bookings: {
    ...
    customer: {
      ...
      nights: '{n} nights',
      total: 'Total',
      noteLabel: 'Note to the office (optional)',
      notePlaceholder: 'Any questions or requests?',
      request: 'Request booking',
      requestSent: 'Request sent',
      requestSentDesc: 'The office will review your request and confirm it shortly.',
      loginToBook: 'Log in to book',
      selectRange: 'Please select your check-in and check-out dates.',
      selectDate: 'Please select a date.',
      selectCheckout: 'Now select your check-out date',
      dayUse: 'Day use',
      dayUseHint: 'Single-day bookings available — tap a date',
      ...
      duration: '{n} hours',
      minHours: 'Minimum {n} hours.',
      invalidTimes: 'Departure must be after arrival.',
      minNights: 'Minimum stay is {n} nights.',
      maxNights: 'Maximum stay is {n} nights.',
      myBookings: 'My bookings',
      mySubtitle: 'Track and manage your booking requests',
      cancel: 'Cancel booking',
      cancelConfirm: 'Cancel this booking? This cannot be undone.',
      keepBooking: 'Keep booking',
      empty: "You haven't made any bookings yet.",
      toast: {
        requestSuccess: 'Booking request sent',
        cancelled: 'Booking cancelled',
        overlap: 'Those dates were just taken. Please pick another range.',
        failed: 'Could not complete your request',
      },
    },
  },
  ...
  search: {
    ...
    rooms: 'Rooms',
    bathrooms: 'Bathrooms',
    heroTitle: 'Find Your Perfect Property in Syria',
